...
def ICC():
    try:
        ...
        print(colored("[✓]", "green"), colored("С уважением HTPFL", "magenta"))
        print("")
        sys.exit(1)
...
def Banner():
	os.system("clear")
	color = ["red", "blue", "yellow", "cyan", "magenta"]
	color2 = choice(color)
	Banner = '''
	...
	Bann1 = colored("[", "blue")
	print("                   "+strftime(colored("%H:%M:%S", "red")))
	print("")
	print("      "+Bann1+colored("HTPFL - Hack The Panel From Lucky", "green"))
	print("      "+Bann1+"Version :"+colored("0.10.1", "red"))
	print("      "+Bann1+"Codename :"+colored("Lucky", "green"))
	print("      "+Bann1+"Latest update :"+"["+colored("06.09.2020", "red")+"]")
	print("")
    # ---
	color3 = choice(color)
	color4 = choice(color)
	...
	print(ist, A1 + A2 + A3, A4 + A5 + A6 + A7 + A8 + A9+"              "+kfg3, kfg32)
	fah = (colored("[2]", "red"))
	fah2 = (colored("VPN For Termux", "blue"))
	print(fah, fah2+"          "+phi, phi2)
	psh = colored("[3]", "red")
	psh2 = colored("DDOS", "magenta")
	psh3 = colored("For Wi-Fi", "cyan")
	print(psh, psh2, psh3+"          "+colored("[8]", "red"), colored("Email Spam", "magenta"))
	url = colored("[4]", "red")
...
def act():
    ...
    print(mod2, mod)
    print(colored("[4]", "cyan"), colored("Enter a Key", "magenta"))
    print("")
    print("")
    nz = colored("[0]", "red")
    ...
    if actr == "1" or act == "Update":
    	...
    	print("")
    	key = input(colored("Your Key: ", "red"))
    	print("")
    	while True:
    		Banner()
    		osnova()
...
def ES():
	...
	if es == "1" or es == "start":
		...
		os.system("clear")
		print("")
		print(colored("Спам завершён!", "green"))
		print("")
		sleep(2)
		while True:
			Banner()
...
def about():
    ...
    if numb == "1" or numb == "Sms Bomber":
    	...
    	while True:
    		PhoneInfoga()
    elif numb == "8" or numb == "Email Spam":
    	while True:
    		ES()
