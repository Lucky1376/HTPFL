...
def osnova():
    ...
    if numb == "1" or numb == "Sms Bomber":
        ...
        if ddos == "1":
            print("")
            print(colored("Starting downloads modules...", "green"))
            print("")
            sleep(1.35)
        ...
        if act == "1" or act == "Update":
            ...
            if podtv == "Да" or podtv == "да":
                ...
                print("")
                sleep(1.45)
                os.system("pkg update -y && pkg upgrade -y && pkg update git -y && pkg update python && pip install --upgrade pip && pip install --upgrade colored && pip install --upgrade requests && pip install --upgrade argparse && pip install --upgrade colorama && pip install --upgrade termcolor && pkg update python2 && pip install --upgrade wget && pip install --upgrade humanfriendly")
                print("")
                print(colored("Complete!", "green"))
                print("")
                print("")
